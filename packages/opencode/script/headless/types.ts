...
export type HeadlessHarnessOptions = {
  ...
  /**
   * Serve the deterministic synthetic market-data fixture without replacing the
   * model with the scripted evaluator. Lets a live model run against the same
   * closed fixture window the scripted contract uses.
   */
  fixtureMarketDataOnly?: boolean
