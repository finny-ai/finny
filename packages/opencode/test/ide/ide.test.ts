...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders FINNY_CALLER", () => {
    process.env["FINNY_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode FINNY_CALLER", () => {
    process.env["FINNY_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown FINNY_CALLER", () => {
    process.env["FINNY_CALLER"] = "unknown"
