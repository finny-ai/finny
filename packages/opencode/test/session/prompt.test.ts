...
const mcp = Layer.succeed(
  ...
  MCP.Service.of({
    ...
    robinhood: () => Effect.succeed(undefined),
...
const it = testEffect(closedLayer(makeHttp()))
const noLLMServer = testEffect(closedLayer(makeHttpNoLLMServer()))
const raceNoLLMServer = testEffect(closedLayer(makeHttpNoLLMServer({ processor: "blocking" })))
