...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/finny.git")).toEqual({ owner: "sst", repo: "finny" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/finny")).toEqual({ owner: "sst", repo: "finny" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/finny.git")).toEqual({ owner: "sst", repo: "finny" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/finny")).toEqual({ owner: "sst", repo: "finny" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/finny.git")).toEqual({ owner: "sst", repo: "finny" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/finny")).toEqual({ owner: "sst", repo: "finny" })
})
