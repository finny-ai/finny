...
} from "@/data/dataset-evidence-builder"
...
type FinalizeInput = Omit<BuildDatasetEvidenceV2Input, "csvBytes" | "csvText" | "outputPath"> & {
  dataRoot: string
  csvPath: string
}
...
export async function finalizeDatasetEvidenceFile(input: FinalizeInput): Promise<FinalizedDatasetEvidence> {
