...
const CATEGORIES = ["all", "strategy", "market", "risk", "learning", "decision", "observation"] as const

export function DialogChatInsights() {
  ...
  const insightsDir = path.join(sdk.directory ?? process.cwd(), ".finny/insights")
          ...
          <Show when={!loading() && filteredInsights().length === 0}>
            <box marginTop={1}>
              ...
              <text fg={theme.textMuted} marginTop={1}>
                Save insights during chat conversations using the save_chat_insight tool.
              </text>
              <text fg={theme.textMuted} marginTop={1}>
                Categories: strategy, market, risk, learning, decision, observation
              </text>
            </box>
          </Show>
