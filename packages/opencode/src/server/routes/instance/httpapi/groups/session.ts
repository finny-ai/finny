...
export const PromptPayload = Schema.suspend(() =>
  Schema.Struct(Struct.omit(SessionPrompt.PromptInput.fields, ["sessionID"])),
)
export const CommandPayload = Schema.suspend(() =>
  Schema.Struct(Struct.omit(SessionPrompt.CommandInput.fields, ["sessionID"])),
)
export const ShellPayload = Schema.suspend(() =>
  Schema.Struct(Struct.omit(SessionPrompt.ShellInput.fields, ["sessionID"])),
)
