    ...
    HttpApiGroup.make("mcp")
      .add(
        ...
        HttpApiEndpoint.post("authStart", McpPaths.auth, {
          ...
          error: [UnsupportedOAuthError, ManagedMcpLifecycleError, McpServerNotFoundError],
        }).annotateMerge(
          OpenApi.annotations({
        ...
        HttpApiEndpoint.post("authCallback", McpPaths.authCallback, {
          ...
          error: [HttpApiError.BadRequest, ManagedMcpLifecycleError, McpServerNotFoundError],
        }).annotateMerge(
          OpenApi.annotations({
        ...
        HttpApiEndpoint.delete("authRemove", McpPaths.auth, {
          ...
          error: [ManagedMcpLifecycleError, McpServerNotFoundError],
        }).annotateMerge(
          OpenApi.annotations({
