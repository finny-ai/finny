...
import { ConnectionStatus, CreateInput, Info, SessionWarpInput } from "./workspace-schema"
export { ConnectionStatus, CreateInput, Info, SessionWarpInput } from "./workspace-schema"
...
const sessionPromptNode = {
  kind: "group",
  get dependencies() {
    return [SessionPrompt.node]
  },
} as typeof SessionPrompt.node
