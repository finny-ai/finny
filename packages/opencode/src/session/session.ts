...
export const get = (...args: Parameters<Interface["get"]>) => sessionRuntime.runPromise((s) => s.get(...args))
export const messages = (...args: Parameters<Interface["messages"]>) =>
  sessionRuntime.runPromise((s) => s.messages(...args))
