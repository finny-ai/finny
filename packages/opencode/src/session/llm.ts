    ...
    const run = Effect.fn("LLM.run")(function* (input: StreamRequest) {
      ...
      return {
        ...
        result: streamText({
          ...
          // Keep the synthetic `invalid` tool active so repaired tool-call
          // failures route through the friendly recovery path instead of
          // surfacing as an unavailable-tool runtime error.
