...
export namespace Config {
  ...
  export const Server = z
    .object({
      ...
      mdnsDomain: z.string().optional().describe("Custom domain name for mDNS service (default: finny.local)"),
  ...
  export const Info = z
    .object({
      ...
      default_agent: z
        ...
        .optional()
        .describe(
          "Default agent to use when none is specified. Must be a primary agent. Falls back to 'research' if not set.",
        ),
      username: z
        .string()
        .optional()
