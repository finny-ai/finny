...
import type {
  ...
  Config as Config3,
  ConfigDataAgentInstructionsGetErrors,
  ConfigDataAgentInstructionsGetResponses,
  ConfigDataAgentInstructionsUpdateErrors,
  ConfigDataAgentInstructionsUpdateResponses,
  ConfigFinnyHomeGetErrors,
  ConfigFinnyHomeGetResponses,
  ConfigFinnyHomeUpdateErrors,
  ConfigFinnyHomeUpdateResponses,
  ConfigGetErrors,
  ConfigGetResponses,
...
export class FinnyHome extends HeyApiClient {
  /**
   * Get Finny Home
   *
   * Resolve the effective Finny Home storage root and artifact subpaths.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
    ...
    return (options?.client ?? this.client).get<ConfigFinnyHomeGetResponses, ConfigFinnyHomeGetErrors, ThrowOnError>({
   ...
   * Update Finny Home
   *
   * Save or clear the user-selected Finny Home storage root.
   */
  public update<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class DataAgentInstructions extends HeyApiClient {
  /**
   * Get Data Agent instructions
   *
   * Read the repo-level data-agent/instructions.md source cookbook for the current instance.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
  ...
  /**
   * Update Data Agent instructions
   *
   * Write the repo-level data-agent/instructions.md source cookbook for the current instance.
   */
  public update<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Config2 extends HeyApiClient {
  ...
  private _finnyHome?: FinnyHome
  get finnyHome(): FinnyHome {
    return (this._finnyHome ??= new FinnyHome({ client: this.client }))
  }

  private _dataAgentInstructions?: DataAgentInstructions
  get dataAgentInstructions(): DataAgentInstructions {
    return (this._dataAgentInstructions ??= new DataAgentInstructions({ client: this.client }))
  }
}
