export const dict = {
  ...
  "settings.agents.dataSources.title": "Data sources",
  "settings.agents.dataSources.description":
    "Edit the Data Agent source cookbook for yfinance, Binance, Alpaca, Oracle, Bloomberg, IBKR, and internal CLIs.",
  "settings.agents.dataSources.editorLabel": "Data Agent source instructions",
  "settings.agents.dataSources.action.reload": "Reload",
  "settings.agents.dataSources.action.saving": "Saving...",
  "settings.agents.dataSources.status.missing": "File will be created on save",
  "settings.agents.dataSources.status.loadFailed": "Failed to load Data Agent source instructions.",
  "settings.agents.dataSources.error.noDirectory": "Open a project before editing Data Agent source instructions.",
  "settings.agents.dataSources.toast.saved.title": "Data sources saved",
  "settings.agents.dataSources.toast.saved.description": "Updated data-agent/instructions.md.",
