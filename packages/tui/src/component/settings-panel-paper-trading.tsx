...
export function SettingsPanelPaperTrading() {
  ...
  return (
    <box flexGrow={1} flexDirection="row" gap={2} minHeight={0}>
            ...
            <For each={allSpecs}>
              {(spec) => {
                ...
                return (
                  ...
                  >
                    <text
                      fg={isActive() ? theme.primary : theme.text}
      ...
      {/* Right pane — view-only key list with remove */}
                ...
                fallback={
                  <box flexDirection="column" gap={1}>
                    <text fg={theme.textMuted}>
                      No {activeSpec().displayName} accounts connected.
                    </text>
                    <text fg={theme.textMuted}>
                      Add one from the Portfolio page.
                    </text>
                  </box>
                }
              >
