  ...
  return (
    <box paddingLeft={2} paddingRight={2} paddingBottom={1} gap={1}>
      ...
      <text fg={theme.textMuted}>
        Choose a {props.runMode === "live" ? "live" : "paper/testnet"} brokerage account. Compare native pair and fees before starting.
      </text>
            ...
            return (
              ...
              >
                ...
                <Show when={row.supports && accounts().length === 1}>
                  <text fg={theme.textMuted}>
                    Account: {accounts()[0].label} ({maskKey(accounts()[0].keyId)}) · {accountModeLabel(accounts()[0].mode)}
                  </text>
                </Show>
