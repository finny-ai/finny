...
const TIPS: Tip[] = [
  ...
  "Create a plugin to prevent Finny from reading sensitive files",
  "Use {highlight}finny run{/highlight} for non-interactive scripting",
  "Use {highlight}finny --continue{/highlight} to resume the last session",
  "Use {highlight}finny run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}finny serve{/highlight} for headless API access to Finny",
  "Use {highlight}finny run --attach{/highlight} to connect to a running server",
  "Run {highlight}finny upgrade{/highlight} to update to the latest version",
  "Run {highlight}finny auth list{/highlight} to see all configured providers",
  "Run {highlight}finny agent create{/highlight} for guided agent creation",
  "Use {highlight}/opencode{/highlight} in GitHub issues/PRs to trigger AI actions",
  "Run {highlight}finny github install{/highlight} to set up the GitHub workflow",
  ...
  "Run {highlight}finny debug config{/highlight} to troubleshoot configuration",
