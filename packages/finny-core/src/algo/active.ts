...
function placeholderMission(humanName: string): string {
  ...
  return [
    ...
    "  direction: both",
    "  entry_signal: pending — to be defined when the strategy is authored",
    '  risk_profile: "legacy-unspecified"',
    '  max_drawdown_pct: "legacy-unspecified"',
    '  backtest_window: "legacy-unspecified"',
    "  success_metric: pending — to be defined when the strategy is authored",
    "exit_conditions: pending — to be defined when the strategy is authored",
    "questionnaire:",
    "  - id: market_universe",
    '    question: "What market and universe does this strategy trade?"',
    '    answer: ""',
    "    status: skipped",
    "  - id: timeframe_bar_interval",
    '    question: "What timeframe and bar interval does it use?"',
    '    answer: ""',
    "    status: skipped",
    "  - id: strategy_family",
    '    question: "What strategy family does it belong to?"',
    '    answer: ""',
    "    status: skipped",
    "  - id: directional_thesis_regime",
    '    question: "What directional thesis and regime does it target?"',
    '    answer: ""',
    "    status: skipped",
    "  - id: entry_signal_idea",
    '    question: "What is the entry signal idea?"',
    '    answer: ""',
    "    status: skipped",
    "  - id: exit_invalidation_rules",
    '    question: "What are the exit and invalidation rules?"',
    '    answer: ""',
    "    status: skipped",
    "  - id: risk_tolerance_max_drawdown",
    '    question: "What risk tolerance and maximum drawdown apply?"',
    '    answer: ""',
    "    status: skipped",
    "  - id: backtest_window_success_metric",
    '    question: "What backtest window and success metric apply?"',
    '    answer: ""',
    "    status: skipped",
    "---",
    "",
