...
Generates UPCOMING_CHANGELOG.md by running the finny changelog command.

Options:
  -f, --from <version>   Starting version (default: latest non-draft GitHub release)
  -t, --to <ref>         Ending ref (default: HEAD)
      --variant <name>   Thinking variant for finny run (default: low)
      --quiet            Suppress finny command output unless it fails
